...
Recent Linux kernel images shipped with distributions should already have sufficient debugging features enabled for the purposes of this guide.
If you are using an older kernel or require additional features such as forced module unloading (\cpp|MODULE_FORCE_UNLOAD|): when this option is enabled,
...
In that case, you may want to recompile your kernel with the necessary options, or consider running the examples within a test distribution on a virtual machine.
